...
Данное программное обеспечение разработано исключительно в образовательных и исследовательских целях. Проект демонстрирует уязвимости механизмов захвата экрана и методы защиты от них. Автор не несет ответственности за использование данного кода в противоправных действиях.
