...
SafeScreen — это прототип программного комплекса класса Endpoint Protection, предназначенный для предотвращения несанкционированного создания снимков экрана (скриншотов) с экрана рабочего стола.
